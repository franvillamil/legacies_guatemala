...
Including turnout as a control variable in cross-sectional models on each election (as that data is not available across all elections (e.g. no obs for 2007, many missing in 2003)) and that would mean a loss of observations.
