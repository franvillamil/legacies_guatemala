...
\title{\Large \textbf{Revision memo}\\{\large Manuscript `Violence, co-optation, and postwar voting in Guatemala', submitted to Conflict Management and Peace Science (CMPS-21-0042.R1)}}
\author{}
\date{\today}
...
I would like to thank the reviewer for all the comments, which were very helpful when revising the manuscript.
I respond to each of them below.
