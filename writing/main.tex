...
{\color{red}{\textbf{PASAR A GRAMMARLY}}}
...
{\color{red}{\textbf{revisar intro after all changes for RnR}}}

Conflicts leave deep scars in postwar societies, but they do not always do so the way it is usually implied.
Previous research shows that civilian victimization triggers a counter-mobilization against the perpetrator that lasts for a long period of time \citep{Balcells:2012aa, Lupu:2017aa, Fontana:2017aa, Rozenas:2017aa, Rozenas:2019aa}.
...
Because a direct measure of prewar mobilization is not available, I use two proxies based on road infrastructure: distance to the Pan-American Highway and the local share of non-paved roads around 1970.
The assumption justifying these variables is that road accessibility determined how much exposure local communities had to external political actors, who came to bring new political ideas and organize the local population.
...
Before the war, they had been more exposed to leftist ideas of political and economic discrimination, which better equipped them to understand the conflict and develop collective memories of it.
...
On the one hand, the Catholic Action priests inspired by Liberation Theology, which was already becoming a key political influence in Latin American \citep[e.g.][]{Wood:2003aa}.
...
The empirical expectations are based on two observations.
...
In the appendix I also include results including more political parties, both on the right and the left (appendix~\ref{app:results_full}).
...
On the contrary, in communities that had not been exposed to prewar leftist mobilization, the state should have been able to successfully co-opt the local population and avoid being blamed for the violence, or even blaming the guerrillas for the wartime atrocities.
...
In a separate section below, I discuss qualitative evidence in support of the assumptions of the argument and the two mechanisms presented.
...
{\color{red}{\textbf{discuss alternative explanation of insularity from national politics?}}}

{\color{red}{\textbf{add reference to next section}}}
...
In particular, I discuss four main points: how the road infrastructure was a crucial factor explaining the difussion of political mobilization in the years prior to the violence, the relationship between the presence of priests and activists and local mobilization activities, the role of state propaganda, and the existence of local commemoration activities in the postwar period.
...
Finally, one of the steps of the theoretical mechanism is that areas that had been exposed to prewar political mobilization were able to create their own collective memories of the conflict.
...
These local initiatives are of major importance to the creation of collective memories, particularly because ``in some communities, people have never spoken of what happened to them even within their own families'' \citet[161]{Arriaza:2008wf}.
...
For example, talking about a memorial cross built by a local community in Alta Verapaz, \citt[170--171]{Viaene:2011td} explains that the ``cross also created space for openly challenging and offering a counter-narrative against the army discourse that all the people who hid in the mountains were guerrilleros ... and therefore responsible for the atrocities.''

This type of activities, however, did not take place everywhere. \citet{Viaene:2011td} talks about an isolated community in the same area that did not participate in the memorial construction, as both the army and the PAC enjoyed local control and had threated local people \citep{Viaene:2011td}.
