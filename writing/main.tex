...
The PAC system was indeed designed to ensure compliance within the countryside.
...
One of the goals of the system was to destroy community networks and erode local interpersonal trust, which presumably had helped the guerrillas organize a local base of support \citep{SaenzdeTejada:2004aa}.
...
I argue that this state-led strategy was key to understand the long-term consequences of victimization in Guatemala.
...
My argument states that this resistance was possible in places that had been exposed to prewar leftist mobilization, as they had the ideological tools to interpret wartime events in a different way.

A potential second mechanism explaining these heterogenous effects discounts the importance of state propaganda.
Instead of resisting to propaganda and co-optation efforts, areas that had been exposed to prewar leftist mobilization could have judged state violence differently, precisely because of their leftist orientation.
...
Before the war, they had been more exposed to leftist ideas of political and economic discrimination, and were better equipped to understand the conflict and develop collective memories of it.
...
An alternative but complementary mechanism also explains the differences between communities with and without exposure to this prewar mobilization without the need of state propaganda.
Previous research shows that the short-term effect of wartime violence on combatant support varies depending on whether the perpetrator is part of the in-group or not \citep{Lyall:2013aa}, as civilians evaluate wartime events according by their previous political orientation \citep{Pechenkina:2020ul, Silverman:2019aa}.
A left-leaning ideological context would determine the way local communities judge wartime events and assign blame.
Thus, even without taking into account propaganda and co-optation strategies by the state, areas that had been more exposed to prewar leftist mobilization should judge wartime state actions in a more negative way.
Although this mechanism mainly refer to short-term reactions during the conflict, it would not be daring to assume that these beliefs determined political preferences after the war.

This mechanism hinges on a ideology-driven active judgement of state violence, but it is not at odds with the former discussion on the capacity of some communities to resist state propaganda, which is also driven by local ideology.
