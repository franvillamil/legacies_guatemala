...
We know that civilian victimization triggers a counter-mobilization against the perpetrator that lasts for a long time \citep{Balcells:2012aa, Lupu:2017aa, Fontana:2017aa, Rozenas:2017aa, Rozenas:2019aa}, but we are agnostic about the conditions that determine the way civilians remember violent events.
One factor that can influence this remembering process are efforts by political elites to try to steer memories of wartime events, by changing the official discourse or spreading misinformation.
...
% Thus, violence is assumed to have a homogenous effect across different communities.

This paper tries to address this limitation, studying the effect of violence on postwar preferences and how this effect can vary depending on the exposure to propaganda and co-optation strategies.
...
These processes are related to what is referred to as rumors in the literature on misinformation, or ``fringe beliefs ... [that] acquire their power through widespread social transmission.'' \citep[243]{Berinsky:2017ty}.
...
\begin{table}[!htbp] \centering
  ...
  % \input{tab/results_nat.tex} # NOTE why is it not working now? (oct 2021)
  \hline
  \hline \\[-1.8ex]
  \end{tabular}
